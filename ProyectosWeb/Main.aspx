...
<br />
 <div><asp:Button ID="ButtonAsignarModSis" class="btn btn-primary"
          ...
          <br />
         <br style="height:80;" />
                        <asp:GridView  ID="GridViewCRConsulta" runat="server" Width="100%" BackColor="White" 
                            BorderColor="#3366CC" Font-Size="XX-Small" AllowPaging="true" BorderStyle="None"
                            Font-Bold="true"
                             BorderWidth="1px" CellPadding="4" PagerSettings-Mode="NextPreviousFirstLast" PageSize="10"
                             OnPageIndexChanging="GridView2Seg_PageIndexChanging" PagerStyle-HorizontalAlign="Center" 
                            PagerSettings-NextPageText="Siguiente" PagerSettings-PreviousPageText="Anterior" PagerStyle-VerticalAlign="Middle">
